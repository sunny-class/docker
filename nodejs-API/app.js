...
console.log(__dirname+"/images/devopslogo.jpg");
*/
app.get('/devops', function(request, response) {
    ...
    response.write("<h2><center>Welcome to sample nodejs app <center></h2>" );
    response.end();
  ...
  app.get('/docker', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  devops <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    ...
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/devopstechnologies");
      })
